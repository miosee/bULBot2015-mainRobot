...
# 8 "../CanLib/CanDspic.h" 2
# 1 "../CanLib/../CanLib/CanNetwork.h" 1
# 9 "../CanLib/CanDspic.h" 2
# 37 "../CanLib/CanDspic.h"
typedef struct
{
 unsigned char id;
 void *ptrData;
...
# 10 "main.c" 2
# 1 "../CanLib/CanNetwork.h" 1
# 11 "main.c" 2

# 1 "../Peripherals/timers.h" 1
# 31 "../Peripherals/timers.h"
typedef enum {
    TIMER_SUCCESS = 0,
    TIMER_ID_ERROR = 1,
    TIMER_PERIOD_ERROR = 2,
}timerStatus;
# 44 "../Peripherals/timers.h"
...
inline void setPos(void) {
 ...
 curPos.alpha = canData.int2*((3.14159)/1800.0);
 IEC0bits.T1IE = 0;
 odoSetAbsPos(curPos);
...
int main(void) {
 propStateType oldState;
 csgStatusType csgStatus;
 relativeCoord nomVel;
 relativeCoord nomAcc;
   ...
   case STANDING:
    if (canReceivedOrderFlag) {
     switch (canReceivedCommand) {
      ...
      case 1:
       canData = getCanData();
       tmp0 = ((3.14159)/1800.0)*canData.int0;
       tmp1 = ((3.14159)/1800.0)*canData.int1;
       tmp2 = ((3.14159)/1800.0)*canData.int2;
       IEC0bits.T1IE = 0;
      ...
      case 8:
       ...
       finalPos.x = canData.int0/1000.0;
       finalPos.y = canData.int1/1000.0;
       finalPos.alpha = canData.int2*((3.14159)/1800.0);
       nbSeg = findTrajectoire(curPos, finalPos, path, obstacle);
       if (nbSeg < 0) {
        state = nbSeg;
       } else {
