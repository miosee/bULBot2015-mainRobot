...
# 3 "Motors.c" 2
# 1 "../Peripherals/pps.h" 1
# 16 "../Peripherals/pps.h"
typedef enum {
    PPS_SUCCESS = 0,
    PPS_PERIPH_ERROR = 1,
    PPS_PIN_ERROR = 2,
...
# 92 "../Peripherals/pps.h"
ppsStatus ppsInConfig(ppsInput periphInput, int rpPin);
# 4 "Motors.c" 2
# 1 "../Peripherals/pwm.h" 1
# 14 "../Peripherals/pwm.h"
typedef enum {
    PWM_SUCCESS = 0,
    PWM_TID_ERROR = 1,
    PWM_PERIOD_ERROR = 2,
...
void motorsInit(void) {
 ...
 ppsOutConfig(PPS_OC1, 18);
 AD1PCFGLbits.PCFG8 = 1;
 ppsOutConfig(PPS_OC2, 16);
 AD1PCFGLbits.PCFG6 = 1;
 ppsOutConfig(PPS_OC3, 14);
 ppsOutConfig(PPS_OC4, 13);
...
void motorsSetSpeed(float dcR, float dcL) {
 if (dcR > 0) {
  pwmSetDutyCycle((1), dcR);
  pwmSetDutyCycle((2), 0);
 } else {
  pwmSetDutyCycle((1), 0);
  pwmSetDutyCycle((2), -dcR);
 }
 if (dcL > 0) {
  pwmSetDutyCycle((3), dcL);
  pwmSetDutyCycle((4), 0);
 } else {
  pwmSetDutyCycle((3), 0);
  pwmSetDutyCycle((4), -dcL);
 }
}
